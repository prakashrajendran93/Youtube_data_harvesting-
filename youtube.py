...
# Function to create the 'youtube' database if it doesn't exist
def create_database():
...
# Function to create tables within the 'youtube' database
...
# Function to convert ISO date format to datetime
...
# Function to check if data already exists in channel table
...
def push_to_mysql(df_channel, df_video, df_comment):
    ...
    try:
        ...
        if data_already_exists(cursor, df_channel):
            st.warning("The Same data already transferred.")
            return
